  ...
  <div class="min-h-screen flex items-center justify-center bg-gradient-to-br from-red-50 to-red-100 px-4">
    <div class="max-w-md w-full">
      <div class="text-center mb-8">
        ...
        <h1 class="text-4xl font-bold text-primary-700 mb-2">TEMS Safety</h1>
        <p class="text-gray-600">Incident Management & Safety Compliance</p>
      </div>
      ...
      <div class="mt-6 text-center text-sm text-gray-600">
        <p>Safety Officer Access Only</p>
      </div>
    </div>
  </div>
</template>
