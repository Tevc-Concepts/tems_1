...
TASKS:
- Build custom Workspaces for each role (Executive, HR, Fleet Officer,Fleet Manager, Safety Officer, Safety Officer, Finance Manager, Finance Officer,Driver,Operation Manager, Operation Officer, Informal Operator, Border Agent, Community Leader, Analyst).
...
- Ensure compliance to Frappe 15v+
- 

INTER-RELATIONSHIPS:
- Each role’s workspace links to its domain DocTypes and reports.
- Dashboards should pull KPIs from Operations, Governance,Fleet, HR, Finance, Safety, CRM, etc.
